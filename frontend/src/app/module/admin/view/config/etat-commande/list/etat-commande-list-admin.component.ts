...
export class EtatCommandeListAdminComponent implements OnInit {

    protected fileName = 'EtatCommande';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<EtatCommandeDto>();
    ...
    public async edit(dto: EtatCommandeDto) {
    ...
    public async view(dto: EtatCommandeDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: EtatCommandeDto) {
    ...
    public async duplicate(dto: EtatCommandeDto) {
    ...
    public exportPdf(dto: EtatCommandeDto): void {
...
// add
    ...
    get selections(): Array<EtatCommandeDto> {
        return this.service.selections;
    }

    set selections(value: Array<EtatCommandeDto>) {
