...
export class CommandeDetailListAdminComponent implements OnInit {

    protected fileName = 'CommandeDetail';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<CommandeDetailDto>();
    ...
    public async edit(dto: CommandeDetailDto) {
    ...
    public async view(dto: CommandeDetailDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: CommandeDetailDto) {
    ...
    public async duplicate(dto: CommandeDetailDto) {
    ...
    public exportPdf(dto: CommandeDetailDto): void {
...
// add
	...
	public initDuplicate(res: CommandeDetailDto) {
	}
    ...
    get selections(): Array<CommandeDetailDto> {
        return this.service.selections;
    }

    set selections(value: Array<CommandeDetailDto>) {
