...
@Component({
  selector: 'app-commande-detail-edit-admin',
  standalone: false,
  templateUrl: './commande-detail-edit-admin.component.html'
})
export class CommandeDetailEditAdminComponent implements OnInit {
