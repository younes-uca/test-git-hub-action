...
export class CommandeEditAdminComponent implements OnInit {
 ...
 public edit(): void {
    ...
    public validateCommandeDetails(){
    ...
    private validateCommandeDetailsPrix(){
    ...
    private validateCommandeDetailsQte(){
    ...
    private validateCommandeDetailsCommande(){
    ...
    private validateCommandeDetailsProduit(){
